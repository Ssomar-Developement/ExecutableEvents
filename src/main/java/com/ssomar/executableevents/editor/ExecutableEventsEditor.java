...
public class ExecutableEventsEditor extends NewSObjectsEditorAbstract {


    public ExecutableEventsEditor() {
        super(ExecutableEvents.plugin, "&lExecutableEvents", "/events", ExecutableEventsManager.getInstance(), ExecutableEventLoader.getInstance(), true);
    }
}
