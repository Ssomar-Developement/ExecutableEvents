package com.ssomar.executableevents.features;
...
public class LoopTypeFeature extends FeatureAbstract<Optional<LoopTypeFeature.LoopType>, LoopTypeFeature> implements FeatureRequireOnlyClicksInEditor {
    ...
    public LoopTypeFeature(FeatureParentInterface parent, String name, Optional<LoopType> defaultValue, String editorName, String[] editorDescription, Material editorMaterial, boolean requirePremium) {
    ...
    public LoopTypeFeature clone(FeatureParentInterface newParent) {
        LoopTypeFeature clone = new LoopTypeFeature(newParent, this.getName(), getDefaultValue(), getEditorName(), getEditorDescription(), getEditorMaterial(), requirePremium());
        clone.value = value;
        return clone;
    }
